...
def train_model(X, Y, name, plot=False):
    ...
    for train, test in cv:
        ...
        train_score = clf.score(X_train, y_t rain)
    ...
    joblib.dump(clf, 'saved_model/LOGISTICCEP.pkl')
    print scores
...
if __name__ == "__main__":
    ...
    plot_confusion_matrix(cm_norm, genre_list, "ceps"," Logistic CEPS classifier - Confusion matrix")
    print " All Done\n"
