...
from utils import  plot_confusion_matrix, GENRE_DIR, GENRE_LIST, TEST_DIR
...
def test_model_on_single_file(file_path):
    clf = joblib.load('saved_model/SVMCEP.pkl')
...
if __name__ == "__main__":
    ...
    test_file = "C:/Users/abc/Dropbox/practicaltraining/data/testdata/metaltest.wav"
