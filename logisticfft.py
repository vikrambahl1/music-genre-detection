...
from fft import read_fft, read_ceps_test
...
def train_model(X, Y, name, plot=False):
    ...
    joblib.dump(clf, 'saved_model/LOGISTICFFT.pkl')
...
if __name__ == "__main__":
    ...
    plot_confusion_matrix(cm_norm, genre_list, "fft","logistic FFT classifier - Confusion matrix")
    print " All Done\n"
