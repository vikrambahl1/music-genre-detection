# -*- coding: utf-8 -*-
"""
Created on Mon May 02 22:40:09 2016
...
def train_model(X, Y, name, plot=False):
    ...
    joblib.dump(clf, 'saved_model/SVMCEP.pkl')
    print scores
...
if __name__ == "__main__":
    ...
    plot_confusion_matrix(cm_norm, genre_list, "ceps"," SVM CEPS classifier - Confusion matrix")
    print " All Done\n"
